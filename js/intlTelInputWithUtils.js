...
(function (factory) {
  ...
  var factoryOutput = (() => {
    ...
    var Iti = class {
      ...
      _generateMarkup() {
        ...
        if (allowDropdown || showFlags) {
          this.countryContainer = createEl(
            "div",
            { class: "iti__country-container ms-3" },
            wrapper
          );
        ...
        if (strictMode || separateDialCode) {
          this._handleKeydownEvent = (e) => {
            if (
              ...
              if (strictMode) {
                const isInitialPlus =
                  this.telInput.selectionStart === 0 && e.key === "+";
        ...
        if (!this.options.useFullscreenPopup) {
          ...
          if (this.options.dropdownContainer) {
            this.dropdown.style.top = `${
              inputPosRelativeToVP.top + inputHeight
            }px`;
      ...
      _updateMaxLength() {
        const { strictMode, placeholderNumberType, validationNumberType } =
          this.options;
    ...
    (function () {
        ...
        Da = {
          ...
          GY: [
            ...
            [
              ,
              ,
              "(?:510|6\\d\\d|7(?:[013]\\d|2[0-25-8]|4[0-29]))\\d{4}",
              ,
              ,
              ,
              "6091234",
          ...
          KE: [
            ...
            [
              ,
              ,
              "(?:1(?:0[0-8]|1[0-5]|2[014]|30)|7\\d\\d)\\d{6}",
              ,
              ,
              ,
              "712123456",
      ...
      function rb(a) {
        ...
        if (1 != r(a.l, 10)) var d = false;
          ...
          (d = a.g.toString()),
            (d =
              "1" == d.charAt(0) && "0" != d.charAt(1) && "1" != d.charAt(1));
        d
          ? ((c = 1), a.h.g("1").g(" "), (a.ca = true))
          : q(a.l, 15) &&
            ...
            null != d &&
              null != d[0] &&
              0 < d[0].length &&
              ((a.ca = true), (c = d[0].length), a.h.g(b.substring(0, c))));
        E(a.g);
        a.g.g(b.substring(c));
